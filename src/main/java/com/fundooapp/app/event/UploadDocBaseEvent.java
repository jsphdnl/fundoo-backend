...
import com.fundooapp.app.entity.UploadDocEntity;
...
public class UploadDocBaseEvent extends Event<Entity>{

    private UploadDocEntity entity;

    public UploadDocBaseEvent() {

    }

    public UploadDocBaseEvent(UploadDocEntity entity, String eventName, String traceId) {
    ...
    @Override
    @AccessType(AccessType.Type.PROPERTY)
    public UploadDocEntity getEntity() {
        return this.entity;
    }

    public void setEntity(UploadDocEntity entity) {
        this.entity = entity;
    }
